...
% Last Modified by GUIDE v2.5 13-Jun-2014 11:16:09
...
fclose(fid1);
set(handles.ref1Spec,'Enable','on');
...
fclose(fid2);
set(handles.ref2Spec,'Enable','on');
...
fclose(fid3);
set(handles.ref3Spec,'Enable','on');
guidata(hObject,handles);
...
axis([min(handles.Energy),max(handles.Energy),-0.2,1.5])
guidata(hObject,handles);
...
% --- Executes on button press in ref1Spec.
function ref1Spec_Callback(hObject, eventdata, handles)
axes(handles.axes2);
handles.ref1Spec = plot(handles.ref1all(1,:), handles.ref1, 'r');
hold on;


% --- Executes on button press in ref2Spec.
function ref2Spec_Callback(hObject, eventdata, handles)
axes(handles.axes2);
handles.ref2Spec = plot(handles.ref2all(1,:), handles.ref2, 'g');
hold on;


% --- Executes on button press in ref3Spec.
function ref3Spec_Callback(hObject, eventdata, handles)
axes(handles.axes2);
